                ...
                <div class="comment-wrapper fix">
                    ...
                    <div class="comment-form">
                        <form action="process/access.php" method="POST">
                            <div class="input-box input-2"><input type="text" placeholder="Name" name="nm"></div>
                            <div class="input-box input-2"><input type="email" placeholder="Email" name="emial"></div>
                            <div class="input-box input-2"><input type="text" placeholder="Phone Number" name="foneNum"></div>
                            <div class="input-box input-2"><input type="text" placeholder="Password" name="pass"></div>
                            <div class="input-box input-2"><input type="text" placeholder="Confirm Password" name="conPass"></div>
                            <div class="input-box"><input type="submit" value="Submit" name="user_reg"></div>
                        </form>
                    </div>
                </div>
            </div>
