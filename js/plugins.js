...
!(function ($) {
  ...
  $.fn.meanmenu = function (e) {
    ...
    return this.each(function () {
      ...
      var M = "",
        P = function () {
          M.php(jQuery(M).is(".meanmenu-reveal.meanclose") ? r : s);
        },
        W = function () {
                ...
                jQuery(".mean-nav ul > li > a:first-child").on(
                  ...
                  function () {
                    jQuery(".mean-nav ul:first").slideUp(),
                      (A = !1),
                      jQuery(M).toggleClass("meanclose").php(s);
                  }
                );
          } else W();
        };
        ...
        b.slideCount > b.options.slidesToShow
          ? (b.$prevArrow
            ...
            b.$nextArrow
              .removeClass("slick-hidden")
              .removeAttr("aria-hidden tabindex"),
            b.phpExpr.test(b.options.prevArrow) &&
              b.$prevArrow.prependTo(b.options.appendArrows),
            b.phpExpr.test(b.options.nextArrow) &&
      ...
      c.autoPlayClear(),
        ...
        c.$prevArrow &&
          ...
          (c.$prevArrow
            ...
            .css("display", ""),
          c.phpExpr.test(c.options.prevArrow) && c.$prevArrow.remove()),
        c.$nextArrow &&
          c.$nextArrow.length &&
          (c.$nextArrow
            .removeClass("slick-disabled slick-arrow slick-hidden")
            .removeAttr("aria-hidden aria-disabled tabindex")
            .css("display", ""),
          c.phpExpr.test(c.options.nextArrow) && c.$nextArrow.remove()),
        c.$slides &&
          (c.$slides
            .removeClass(
...
!(function (jQuery, ytp) {
  (jQuery.mbYTPlayer = {
                              ...
                              (eventType = "YTPPlay"),
                                YTPlayer.controlBar.length &&
                                  YTPlayer.controlBar
                                    ...
                                    .php(jQuery.mbYTPlayer.controls.pause),
                            ...
                            case 2:
                              (eventType = "YTPPause"),
                                YTPlayer.controlBar.length &&
                                  YTPlayer.controlBar
                                    .find(".mb_YTPPlaypause")
                                    .php(jQuery.mbYTPlayer.controls.play);
                              break;
                            case 3:
        ...
        jQuery(document)
          ...
          .on(fullscreenchange, function () {
            ...
            a
              ...
              : ((YTPlayer.isAlone = !1),
                fullScreenBtn.php(jQuery.mbYTPlayer.controls.onlyYT),
        ...
        YTPlayer.isAlone
          ...
          : (jQuery(document).on("mousemove.YTPlayer", function (a) {
            ...
            real
              ...
              : videoWrapper
                  .css({ zIndex: 1e4 })
                  .CSSAnimate({ opacity: 1 }, YTPlayer.opt.fadeOnStartTime),
            fullScreenBtn.php(jQuery.mbYTPlayer.controls.showSite),
            (YTPlayer.isAlone = !0)),
        this
      );
    },
    ...
    play: function () {
      ...
      return (
        c.php(jQuery.mbYTPlayer.controls.pause),
        (a.state = 1),
    ...
    stop: function () {
      var a = this.get(0),
        ...
        c = b.find(".mb_YTPPlaypause");
      return c.php(jQuery.mbYTPlayer.controls.play), a.player.stopVideo(), this;
    },
    pause: function () {
      var a = this.get(0);
    ...
    mute: function () {
      ...
      if (!a.isMute) {
        ...
        c.php(jQuery.mbYTPlayer.controls.unmute),
    ...
    unmute: function () {
      ...
      if (a.isMute) {
        ...
        var b = jQuery("#controlBar_" + a.id),
          c = b.find(".mb_YTPMuteUnmute");
        c.php(jQuery.mbYTPlayer.controls.mute),
    ...
    buildControls: function (YTPlayer) {
      ...
      if (
        ...
        var movieUrl = jQuery("<span/>")
            .php(jQuery.mbYTPlayer.controls.ytLogo)
          ...
          onlyVideo = jQuery("<span/>")
            .php(jQuery.mbYTPlayer.controls.onlyYT)
    ...
    (jQuery.fn.optimizeDisplay = function (a) {
      var b = this.get(0),
        c = jQuery(b.playerEl),
        d = {};
      (b.opt.anchor = a || b.opt.anchor),
        (b.opt.anchor =
          "undefined " != typeof b.opt.anchor ? b.opt.anchor : "center,center");
      ...
      if (b.opt.optimizeDisplay) {
        ...
        (g.width = h.outerWidth()),
          (g.height = h.outerHeight() + f),
          (d.width = g.width),
          (d.height =
            "16/9" == b.opt.ratio
              ? Math.ceil(d.width * (9 / 16))
              : Math.ceil(0.75 * d.width)),
        ...
        i &&
          ...
          (d.width =
            "16/9" == b.opt.ratio
              ? Math.floor(d.height * (16 / 9))
              : Math.floor(d.height * (4 / 3))),
          (d.marginTop = 0),
