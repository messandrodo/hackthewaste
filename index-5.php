...
<!-- Mirrored from demo.hasthemes.com/greensoul-preview/greensoul/index-5.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 26 Mar 2021 19:15:18 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <div class="wrapper fix">
                            ...
                            <nav>
                                <ul>
                                    <li><a href="index.php">home</a>
                                        <ul>
                                            <li><a href="index.php">home (Default Slider)</a></li>
                                            <li><a href="index-2.php">home 2 (BG Image)</a></li>
                                            <li><a href="index-3.php">home 3 (BG Video)</a></li>
                                            <li><a href="index-4.php">home 4 <span class="badge badge-success ml-2">New</span></a></li>
                                            <li><a href="index-5.php">home 5 <span class="badge badge-success ml-2">New</span></a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <li><a href="#">pages</a>
                                        <ul>
                                            ...
                                            <li><a href="causes-details.php">causes details</a></li>
        ...
        <div id="hero-area" class="hero-area section">
            ...
            <div id="hero-slider" class="nivoSlider">
                ...
                <img src="img/hero/3.jpg" alt="" title="#herocaption-2" />
            </div>
            <!-- Hero Slider Caption -->
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="hero-content-2 col-12">
                            <h1 class="wow cusFadeInUp" data-wow-duration=".5s" data-wow-delay="0.5s">We’re green soul <br>& We Care You</h1>
                            <p class="wow cusFadeInUp" data-wow-duration=".5s" data-wow-delay="1s">There are many variations of passages of Lorem Ipsum available, but the majority ha suffd alteration in some form, by injected humour, or randomised words whic't look even slightly believable. If you are going to use a passage.</p>
                            <a href="#" class="learn-more wow cusFadeInRight" data-wow-duration=".5s" data-wow-delay="1.5s">Learn More</a>
                            <a href="#" class="learn-more wow cusFadeInLeft ml-3" data-wow-duration=".5s" data-wow-delay="1.5s">Contact us</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div id="about-area" class="about-area section pt-120 pb-120">
            <div class="container">
                <div class="row">
                    ...
                    <!--  About Content  -->
                    <div class="about-content-2 col-lg-7 col-12 pl-3">
        ...
        <!-- Donation Area Start -->
        <div id="donation-area" class="donation-area section bg-gray pt-120 pb-120">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <!--  Donation Section Title  -->
                        <div class="donation-title-2">
                        ...
                        <div class="donation-form-2">
                            <form action="#" id="donation-form-2">
                                <div class="row mb-n4">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12 mb-4"><input type="submit" value="donate now"></div>
                                </div>
                            </form>
                        </div>
                    </div>
